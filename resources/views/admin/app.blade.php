...
<head>
    ...
    <title>Dashboard | Softvence </title>
            ...
            <ul class="side-nav">
                ...
                <li class="side-nav-item">
                    <a href="{{route('courses.index')}}" class="side-nav-link">
                        <i class="ri-dashboard-3-line"></i>
                        <span> Courses Show </span>
                    </a>
                </li>

                <li class="side-nav-item">
                    <a href="{{route('courses.create')}}" class="side-nav-link">
                        <i class="ri-dashboard-3-line"></i>
                        <span> Courses Create </span>
                    </a>
                </li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 text-center">
                        <script>document.write(new Date().getFullYear())</script> © Softvence </b>
                    </div>
                </div>
            </div>
        </footer>
